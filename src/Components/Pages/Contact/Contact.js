...
const Contact = () => {
  ...
  return (
    <div>
      <div className="mt-5 lg:px-16  rounded-xl">
        <h2 className="text-orange-500 text-center text-3xl font-bold uppercase mb-5">
          Contact Us
        </h2>
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:justify-items-center  lg:gap-3 border-2 shadow-2xl shadow-blue-700 p-10 rounded-xl">
          <div>
            <img
          ...
          <div className="card w-96   shadow-inner shadow-blue-600">
