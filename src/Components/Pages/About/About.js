    ...
    <div className="bg-slate-300">
      <div className="hero min-h-screen ">
        <div className="hero-content flex-col lg:flex-row gap-8">
          <img src={add} className="w-32 md:w-32 lg:w-3/5 rounded-lg " alt="" />
          <div className="ms-32">
            ...
            <p className="py-6 text-xl">
              ...
              job portals and best job portals in . The Internet is a big place
              with more than 3 billion people using it every day - some for
              personal and some for business use. According to the survey, is
              the second highest user of internet.
            </p>
            <button data-theme="autumn" className="btn btn-primary">
              See More
            </button>
          </div>
        </div>
